...
import {
  Search, Users, Eye, ChevronLeft, ChevronRight,
} from 'lucide-react';
...
const DoctorPatientsList = () => {
  ...
  const pageBtn = (active, disabled) => ({
    ...
    backgroundColor: active ? '#0891b2' : disabled ? '#f9fafb' : '#ffffff',
    ...
    <Layout title="Patients">
      <div style={{
        ...
        <div style={{
          ...
          {[
            { label: 'Total patients', value: patients.length,         color: '#0891b2' },
