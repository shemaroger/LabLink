...
import {
  ...
  Edit, Activity, FileText, Stethoscope,
} from 'lucide-react';
    ...
    <Layout title="Patients">
      <div style={{
        ...
        <div style={{
          ...
          {/* Admin / receptionist — add patient */}
          {!isNurse && !isDoctor && (
            <button
            ...
            >
              ...
              {isReceptionist ? 'Register patient' : 'Add patient'}
            </button>
          )}
        ...
        <div style={{
          ...
          {[
            { label: 'Total patients', value: patients.length,                                              color: '#6b77c0' },
                ...
                <tbody>
                  {paginated.map((p, i) => (
                    ...
                    >
                      ...
                      {/* Blood group */}
                      <td style={{
                        ...tdStyle, color: '#6b7280', fontWeight: 600,
                      }}>
                        {p.blood_group || '—'}
                      </td>
